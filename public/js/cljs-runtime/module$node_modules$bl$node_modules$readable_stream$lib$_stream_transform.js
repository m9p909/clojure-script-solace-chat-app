...
typeof this._flush||this._readableState.destroyed?done(this,null,null):this._flush(function(er,data){done(_this,er,data)})}function done(stream,er,data){if(er)return stream.emit("error",er);null!=data&&stream.push(data);if(stream._writableState.length)throw new ERR_TRANSFORM_WITH_LENGTH_0;if(stream._transformState.transforming)throw new ERR_TRANSFORM_ALREADY_TRANSFORMING;return stream.push(null)}module.exports=Transform;global=require("module$node_modules$bl$node_modules$readable_stream$errors").codes;
var ERR_METHOD_NOT_IMPLEMENTED=global.ERR_METHOD_NOT_IMPLEMENTED,ERR_MULTIPLE_CALLBACK=global.ERR_MULTIPLE_CALLBACK,ERR_TRANSFORM_ALREADY_TRANSFORMING=global.ERR_TRANSFORM_ALREADY_TRANSFORMING,ERR_TRANSFORM_WITH_LENGTH_0=global.ERR_TRANSFORM_WITH_LENGTH_0,Duplex=require("module$node_modules$bl$node_modules$readable_stream$lib$_stream_duplex");require("module$node_modules$inherits$inherits_browser")(Transform,Duplex);Transform.prototype.push=function(chunk,encoding){this._transformState.needTransform=
...
//# sourceMappingURL=module$node_modules$bl$node_modules$readable_stream$lib$_stream_transform.js.map
