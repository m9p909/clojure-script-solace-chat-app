...
var i_30871 = (0);
while(true){
if((i_30871 < arr.length)){
(arr[i_30871] = null);

var G__30873 = (i_30871 + (1));
i_30871 = G__30873;
continue;
} else {
}
...
var i_30896 = (self__.level + (1));
while(true){
if((i_30896 <= (new_level + (1)))){
(update[i_30896] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_30898 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30898[i]));
} else {
x__$2.forward.push((((i < links_30898.length))?(links_30898[i]):null));
}

if((i < links_30898.length)){
(links_30898[i] = x__$2);
} else {
links_30898.push(x__$2);
}
...
var i_30900 = (0);
while(true){
if((i_30900 <= self__.level)){
var links_30901 = (update[i_30900]).forward;
if((x__$1 === (((i_30900 < links_30901.length))?(links_30901[i_30900]):null))){
(links_30901[i_30900] = (x__$1.forward[i_30900]));

var G__30903 = (i_30900 + (1));
i_30900 = G__30903;
continue;
} else {
var G__30904 = (i_30900 + (1));
i_30900 = G__30904;
continue;
}
} else {
...
var G__30908 = nx;
var G__30909 = (level__$1 - (1));
x = G__30908;
level__$1 = G__30909;
continue;
} else {
var G__30910 = x;
var G__30911 = (level__$1 - (1));
x = G__30910;
level__$1 = G__30911;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30913 = nx;
var G__30914 = (level__$1 - (1));
x = G__30913;
level__$1 = G__30914;
continue;
} else {
var G__30915 = x;
var G__30916 = (level__$1 - (1));
x = G__30915;
level__$1 = G__30916;
continue;
}
