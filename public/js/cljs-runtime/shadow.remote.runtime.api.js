...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35485 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35485(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35486 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35486(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35487 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35487(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35488 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35488(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35489 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35489(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35492 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35492(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35472,callback){
var map__35473 = p__35472;
var map__35473__$1 = cljs.core.__destructure_map(map__35473);
var input = map__35473__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35473__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35473__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
