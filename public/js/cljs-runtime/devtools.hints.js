...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26961__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26961__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26960){var _e = e26960;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___26995 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___26995)){
var seen_errors_26996 = temp__5751__auto___26995;
if(cljs.core.truth_(seen_errors_26996.has(self))){
} else {
seen_errors_26996.add(self);

var temp__5753__auto___26997 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___26997)){
var sense_26998 = temp__5753__auto___26997;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26998)].join(''));
} else {
}
}
} else {
