...
var G__37891 = o;
reagent.impl.template.goog$module$goog$object.set(G__37891,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37892 = o;
reagent.impl.template.goog$module$goog$object.set(G__37892,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37919__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37922__i < G__37922__a.length) {G__37922__a[G__37922__i] = arguments[G__37922__i + 0]; ++G__37922__i;}
  args = new cljs.core.IndexedSeq(G__37922__a,0,null);
} 
return G__37919__delegate.call(this,args);};
G__37919.cljs$lang$maxFixedArity = 0;
G__37919.cljs$lang$applyTo = (function (arglist__37923){
var args = cljs.core.seq(arglist__37923);
return G__37919__delegate(args);
});
...
var G__37893 = props;
var G__37893__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37893,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37893);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37893__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37894 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37894,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37894;
}
})(),id_class);
...
var G__37895 = (cljs.core.count(argv) - first_child);
switch (G__37895) {
case (0):
...
var vec__37896 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(2),null);
...
var temp__5757__auto___37932 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37932 == null)){
} else {
var key_37933 = temp__5757__auto___37932;
(jsprops.key = key_37933);
}
...
var temp__5757__auto___37936 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37936 == null)){
} else {
var key_37937 = temp__5757__auto___37936;
(jsprops.key = key_37937);
}
...
var temp__5757__auto___37940 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37940 == null)){
} else {
var key_37941 = temp__5757__auto___37940;
(jsprops.key = key_37941);
}
...
var temp__5757__auto___37950 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37950 == null)){
} else {
var key_37951 = temp__5757__auto___37950;
(jsprops.key = key_37951);
}
...
var temp__5757__auto___37954 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37954 == null)){
} else {
var key_37955 = temp__5757__auto___37954;
(jsprops.key = key_37955);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37899_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37899_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37900 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37900,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37900,(1),null);
...
break;
default:
var G__37959 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37906 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37906 = (function (opts,id,fn_to_element,parse_fn,meta37907){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37906.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37908,meta37907__$1){
var self__ = this;
var _37908__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37906(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37907__$1));
}));

(reagent.impl.template.t_reagent$impl$template37906.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37908){
var self__ = this;
var _37908__$1 = this;
return self__.meta37907;
}));

(reagent.impl.template.t_reagent$impl$template37906.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37906.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37906.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37906.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37906.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37906.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37907","meta37907",-1345361236,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37906.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37906.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37906");

(reagent.impl.template.t_reagent$impl$template37906.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template37906");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37906.
 */
reagent.impl.template.__GT_t_reagent$impl$template37906 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37906(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37907){
return (new reagent.impl.template.t_reagent$impl$template37906(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37907));
});

}

return (new reagent.impl.template.t_reagent$impl$template37906(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
