...
var G__30458 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30458;
continue;
} else {
return ch;
...
var vec__30446 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30446,(0),null);
return (match === s);
});
...
var len__4864__auto___30459 = arguments.length;
var i__4865__auto___30460 = (0);
while(true){
if((i__4865__auto___30460 < len__4864__auto___30459)){
args__4870__auto__.push((arguments[i__4865__auto___30460]));

var G__30461 = (i__4865__auto___30460 + (1));
i__4865__auto___30460 = G__30461;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30453){
...
return (function() { 
var G__30462__delegate = function (rdr,_){
...
var G__30462 = function (rdr,var_args){
var _ = null;
...
while (G__30463__i < G__30463__a.length) {G__30463__a[G__30463__i] = arguments[G__30463__i + 1]; ++G__30463__i;}
  _ = new cljs.core.IndexedSeq(G__30463__a,0,null);
} 
return G__30462__delegate.call(this,rdr,_);};
G__30462.cljs$lang$maxFixedArity = 1;
G__30462.cljs$lang$applyTo = (function (arglist__30464){
var rdr = cljs.core.first(arglist__30464);
var _ = cljs.core.rest(arglist__30464);
return G__30462__delegate(rdr,_);
});
