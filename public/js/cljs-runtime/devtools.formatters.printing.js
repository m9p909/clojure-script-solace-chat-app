...
var len__4864__auto___29858 = arguments.length;
var i__4865__auto___29859 = (0);
while(true){
if((i__4865__auto___29859 < len__4864__auto___29858)){
args__4870__auto__.push((arguments[i__4865__auto___29859]));

var G__29860 = (i__4865__auto___29859 + (1));
i__4865__auto___29859 = G__29860;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29734){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29735,G__29736,seq29734__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29792_SHARP_){
return (!((cljs.core.meta(p1__29792_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29818__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29820){var _e__26884__auto__ = e29820;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e29824){var _e__26884__auto__ = e29824;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29836 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29837 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29837);

try{var map__29840 = opts;
var map__29840__$1 = cljs.core.__destructure_map(map__29840);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29840__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29836);
}});
...
var temp__5751__auto___29896 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___29896)){
var managed_print_level_29897 = temp__5751__auto___29896;
var _STAR_print_level_STAR__orig_val__29849_29898 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29850_29899 = managed_print_level_29897;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29850_29899);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29844_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29844_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29849_29898);
}} else {
job_fn();
}
