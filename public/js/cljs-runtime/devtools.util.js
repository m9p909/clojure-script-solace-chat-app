...
var len__4864__auto___29044 = arguments.length;
var i__4865__auto___29045 = (0);
while(true){
if((i__4865__auto___29045 < len__4864__auto___29044)){
args__4870__auto__.push((arguments[i__4865__auto___29045]));

var G__29046 = (i__4865__auto___29045 + (1));
i__4865__auto___29045 = G__29046;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__28967_29047 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__28968_29048 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__28969_29049 = true;
var _STAR_print_fn_STAR__temp_val__28970_29050 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__28969_29049);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__28970_29050);

try{var _STAR_print_level_STAR__orig_val__28971_29053 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28972_29054 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28972_29054);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28971_29053);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__28968_29048);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__28967_29047);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq28966){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28966));
}));
...
var new_formatters = current_formatters.filter((function (p1__28979_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__28979_SHARP_)));
}));
...
var G__28980_29072 = f;
var target__26882__auto___29073 = G__28980_29072;
if(cljs.core.truth_(target__26882__auto___29073)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28980_29072)].join(''),"\n","target__26882__auto__"].join('')));
}

(target__26882__auto___29073["toString"] = (function (){
...
var G__28985_29074 = "%c%s";
var G__28986_29075 = "color:transparent";
var G__28987_29076 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__28985_29074,G__28986_29075,G__28987_29076) : f.call(null,G__28985_29074,G__28986_29075,G__28987_29076));
...
var args__4870__auto__ = [];
var len__4864__auto___29080 = arguments.length;
var i__4865__auto___29081 = (0);
while(true){
if((i__4865__auto___29081 < len__4864__auto___29080)){
args__4870__auto__.push((arguments[i__4865__auto___29081]));

var G__29082 = (i__4865__auto___29081 + (1));
i__4865__auto___29081 = G__29082;
continue;
} else {
}
break;
...
var vec__29005 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29005,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29005,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__29083__delegate = function (add_fmt,add_args){
...
var G__29083 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__29084__i = 0, G__29084__a = new Array(arguments.length -  1);
while (G__29084__i < G__29084__a.length) {G__29084__a[G__29084__i] = arguments[G__29084__i + 1]; ++G__29084__i;}
  add_args = new cljs.core.IndexedSeq(G__29084__a,0,null);
} 
return G__29083__delegate.call(this,add_fmt,add_args);};
G__29083.cljs$lang$maxFixedArity = 1;
G__29083.cljs$lang$applyTo = (function (arglist__29085){
var add_fmt = cljs.core.first(arglist__29085);
var add_args = cljs.core.rest(arglist__29085);
return G__29083__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq28996){
var G__28997 = cljs.core.first(seq28996);
var seq28996__$1 = cljs.core.next(seq28996);
var G__28998 = cljs.core.first(seq28996__$1);
var seq28996__$2 = cljs.core.next(seq28996__$1);
var G__28999 = cljs.core.first(seq28996__$2);
var seq28996__$3 = cljs.core.next(seq28996__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28997,G__28998,G__28999,seq28996__$3);
}));
...
var seq__29020 = cljs.core.seq(features);
var chunk__29021 = null;
var count__29022 = (0);
var i__29023 = (0);
while(true){
if((i__29023 < count__29022)){
var feature = chunk__29021.cljs$core$IIndexed$_nth$arity$2(null,i__29023);
...
var G__29086 = seq__29020;
var G__29087 = chunk__29021;
var G__29088 = count__29022;
var G__29089 = (i__29023 + (1));
seq__29020 = G__29086;
chunk__29021 = G__29087;
count__29022 = G__29088;
i__29023 = G__29089;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__29020);
if(temp__5753__auto__){
var seq__29020__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__29020__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__29020__$1);
var G__29090 = cljs.core.chunk_rest(seq__29020__$1);
var G__29091 = c__4679__auto__;
var G__29092 = cljs.core.count(c__4679__auto__);
var G__29093 = (0);
seq__29020 = G__29090;
chunk__29021 = G__29091;
count__29022 = G__29092;
i__29023 = G__29093;
continue;
} else {
var feature = cljs.core.first(seq__29020__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29094 = cljs.core.next(seq__29020__$1);
var G__29095 = null;
var G__29096 = (0);
var G__29097 = (0);
seq__29020 = G__29094;
chunk__29021 = G__29095;
count__29022 = G__29096;
i__29023 = G__29097;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o29039 = temp__5751__auto__;
return (o29039["version"]);
} else {
return null;
}
})() == null);
