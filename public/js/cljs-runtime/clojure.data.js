...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27013){
...
var vec__27017 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27017,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27017,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27017,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_27055 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27055(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27056 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27056(a,b);
}
});
...
var fexpr__27052 = (function (){var G__27053 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27053__$1)].join('')));

}
})();
return (fexpr__27052.cljs$core$IFn$_invoke$arity$2 ? fexpr__27052.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27052.call(null,a,b));
}));
/**
