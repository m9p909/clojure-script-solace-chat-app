...
var o29238 = temp__5751__auto__;
var temp__5751__auto____$1 = (o29238["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o29239 = temp__5751__auto____$1;
return (o29239["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26877__auto__ = f;
return (o__26877__auto__["toString"]).call(o__26877__auto__);
} else {
return "";
}
}catch (e29240){var _ = e29240;
return "";
}});
...
try{var o__26877__auto___29505 = t;
(o__26877__auto___29505["cljs$lang$ctorPrWriter"]).call(o__26877__auto___29505,t,writer);
}catch (e29242){var __29506 = e29242;
}
...
var char_code = (function (){var o__26877__auto__ = (new String(char$));
return (o__26877__auto__["charCodeAt"]).call(o__26877__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26877__auto__ = String;
return (o__26877__auto__["fromCharCode"]).call(o__26877__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29244 = num_code;
switch (G__29244) {
case (1):
return (185);
...
var o__26877__auto__ = String;
return (o__26877__auto__["fromCharCode"]).call(o__26877__auto__,superscript_code);
});
/**
...
}catch (e29249){var _e__26884__auto__ = e29249;
return false;
}})())){
...
var vec__29251 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29251,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29267){
var vec__29268 = p__29267;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29268,(0),null);
...
var G__29540 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29541 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29540;
remaining_tokens = G__29541;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29261){
var G__29263 = cljs.core.first(seq29261);
var seq29261__$1 = cljs.core.next(seq29261);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29263,seq29261__$1);
}));
...
var vec__29273 = cljs.core.split_with((function (p1__29272_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29272_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29273,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29273,(1),null);
...
var vec__29288 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29288,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29288,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29547 = cljs.core.rest(remaining_tokens);
var G__29548 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29547;
name_tokens = G__29548;
continue;
} else {
...
var vec__29301 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29301,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29301,(1),null);
var vec__29304 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29304,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29304,(1),null);
var vec__29307 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29307,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29307,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29307,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29307,(3),null);
...
var vec__29342 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29342,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__29369 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29369,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29369,(1),null);
var vec__29378 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29378,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29378,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29392 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29392) : devtools.munging.parse_fn_info_deep.call(null,G__29392));
})()));
}
} else {
return fn_info;
...
var G__29560 = (arity + (1));
var G__29561 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29429){
var vec__29431 = p__29429;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29431,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29431,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29439_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29439_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29441_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29441_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29450){
var vec__29451 = p__29450;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29451,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29444){
...
var map__29470 = options;
var map__29470__$1 = cljs.core.__destructure_map(map__29470);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29470__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29470__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29470__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29470__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29471 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29471,(5),null);
...
var o__26877__auto__ = f;
return (o__26877__auto__["getBasis"]).call(o__26877__auto__);
});
/**
...
}catch (e29483){var _e__26884__auto__ = e29483;
...
var G__29576 = (obj[cljs.core.first(path)]);
var G__29577 = cljs.core.rest(path);
obj = G__29576;
path = G__29577;
continue;
} else {
...
var _STAR_ = (function (accum,p__29490){
var vec__29491 = p__29490;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29491,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29491,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29495){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29496,(2),null);
...
var post_process = (function (p__29501){
var vec__29502 = p__29501;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29502,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29502,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29499_SHARP_){
return (obj[cljs.core.first(p1__29499_SHARP_)]);
}),sorted_matches);
